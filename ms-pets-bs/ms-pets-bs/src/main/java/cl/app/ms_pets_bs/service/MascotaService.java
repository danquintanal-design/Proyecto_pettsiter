package cl.app.ms_pets_bs.service;

import cl.app.ms_pets_bs.client.MascotaClient;
...
public class MascotaService {
    ...
    private void validarDatosNegocio(MascotaDTO mascotaDTO) {
        ...
        if (mascotaDTO.getTipo() == MascotaDTO.TipoMascota.PERRO && mascotaDTO.getEdad() != null && mascotaDTO.getEdad() > 10) {
            System.out.println("Mascota senior detectada - considerar cuidados especiales");
        }
    }
}
